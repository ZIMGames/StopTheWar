...
public class GameHandler_GridCombatSystem : MonoBehaviour {
    ...
    private void Awake() {
        ...
        gridPathfinding = new GridPathfinding(origin + new Vector3(1, 1) * cellSize * .5f, new Vector3(mapWidth, mapHeight) * cellSize + origin + new Vector3(1, 1) * cellSize * .5f, cellSize);
        //gridPathfinding = new GridPathfinding(mapWidth, mapHeight, cellSize, origin);
